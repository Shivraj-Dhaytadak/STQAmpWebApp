...
<html>
<head>
<title>Contact Form With Mail function and Database store Facility</title>
...
<input type="text" name="phonenumber" class="phone" placeholder="0900.234.145678" minlength="10" maxlength="10" required autocomplete="off">
